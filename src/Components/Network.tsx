        ...
        <div className="text-center">
            ...
            <div className="flex mx-20 pb-20">
                <div className="bg-white mr-4 p-10 rounded-2xl text-left">
                    ...
                    <p className="flex hover:text-primary"><a href="http://" className="underline font-semibold mr-2">Learn More</a> <img className="pt-1" src={rightarrow} alt="right arrow" /></p>
                </div>
                <div className="bg-white ml-4 p-10 rounded-2xl text-left">
                    ...
                    <p className="font-semibold py-3 mt-4">Raise $5k, $25k, $50k and $125k in 4 bootstrap deals within 12 months </p>
                    <p className="flex hover:text-primary mt-6"><a href="http://" className="underline font-semibold mr-2 ">Learn More</a> <img className="pt-1" src={rightarrow} alt="right arrow" /></p>
                </div>
